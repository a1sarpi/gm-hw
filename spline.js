...
class BicubicSplineX {
    ...
    calc_value(omega, xi, ii, jj) {
        ...
        if (jj == this.M_ctr - 1) {
            let coefs = [this.u_splines[jj].calc_value(omega, ii),
                ...
                this.u_vv_splines[jj].calc_value(omega, ii),
                this.u_vv_splines[0].calc_value(omega, ii)];
            return psi1 * coefs[0] +
                psi2 * coefs[1] +
            ...
            let coefs = [this.u_splines[jj].calc_value(omega, ii),
                ...
                this.u_vv_splines[jj].calc_value(omega, ii),
                this.u_vv_splines[jj + 1].calc_value(omega, ii)];
            return psi1 * coefs[0] +
                psi2 * coefs[1] +
                psi3 * this.d[jj] * this.d[jj] * coefs[2] +
                psi4 * this.d[jj] * this.d[jj] * coefs[3];
    ...
    calc_tangent_u(omega, xi, ii, jj) {
        ...
        //    this.u_vv_splines[jj].calc_second_diff(omega, ii)];
        //return coefs[0] * psi1 + coefs[1] * psi2 +
        //  coefs[2] * this.d[ii] * this.d[ii] * psi3 +
        //  coefs[3] * this.d[ii] * this.d[ii] * psi4;
    }
